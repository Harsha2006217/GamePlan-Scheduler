<?php
// add_event.php: Form to add event
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="schedule_id" name="schedule_id" required>
                        ...
                        <?php foreach ($schedules as $sched): ?>
                            <option value="<?php echo $sched['schedule_id']; ?>"><?php echo htmlspecialchars($sched['game'] . ' on ' . $sched['date']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <?php foreach ($friends as $friend): ?>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="shared_with[]" value="<?php echo $friend['friend_user_id']; ?>">
