...
$id = $_GET['id'] ?? 0;
if (!is_numeric($id)) {
    setMessage('error', 'Invalid friend ID.');
    header('Location: friends.php');
    exit;
}
$friend = getFriendById($id, getUserId());  // Assume getFriendById function added in functions.php
if (!$friend) {
    setMessage('error', 'Friend not found or no permission to edit.');
    header('Location: friends.php');
    exit;
}
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = editFriend($id, $new_username);
    if ($result === true) {
    ...
    <div class="container">
        <div class="section">
            <div class="text-center mb-5">
                ...
                <h1 class="h2 mb-3">Edit Friend</h1>
                <p class="text-muted">Update your friend details</p>
            </div>
            ...
            <form method="POST" onsubmit="return validateAddFriendForm();" class="mb-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="mb-4">
                            <label for="new_username" class="form-label h5">
                                <i class="bi bi-search me-2"></i>New Username
                            </label>
                            <input type="text" class="form-control form-control-lg" id="new_username" name="new_username" 
                                   required placeholder="Enter new friend's username" aria-label="New friend username">
                            <div class="form-text text-muted">
                                Enter the new username for this friend
                            </div>
                        </div>
                        
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                            <button type="submit" class="btn btn-primary btn-lg px-5">
                                <i class="bi bi-plus-circle me-2"></i>Update Friend
                            </button>
