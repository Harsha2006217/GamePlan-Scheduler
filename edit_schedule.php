...
if (!$schedule) {
    setMessage('error', 'Schedule not found or no permission to edit.');
    header('Location: index.php');
    exit;
}
$games = getGames();
    ...
    <div class="container">
        <div class="section">
            <div class="text-center mb-5">
                ...
                <h1 class="h2 mb-3">Edit Gaming Schedule</h1>
                <p class="text-muted">Update your gaming session details</p>
            </div>
            ...
            <div class="schedule-info">
                <h5 class="mb-3"><i class="bi bi-info-circle me-2"></i>Current Schedule Details</h5>
                <div class="row">
                    <div class="col-md-4">
                        <strong>Game:</strong> 
                        <?php 
                            $currentGame = array_filter($games, fn($g) => $g['game_id'] == $schedule['game_id']);
                            $gameTitle = !empty($currentGame) ? reset($currentGame)['titel'] : 'Unknown Game';
                            echo htmlspecialchars($gameTitle);
                        ?>
                    </div>
                    <div class="col-md-4">
                        <strong>Date:</strong> <?php echo htmlspecialchars($schedule['date']); ?>
                    </div>
                    <div class="col-md-4">
                        <strong>Time:</strong> <?php echo htmlspecialchars($schedule['time']); ?>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" onsubmit="return validateScheduleForm();">
                                ...
                                <select class="form-select" id="game_id" name="game_id" required aria-label="Select game">
                                    ...
                                    <?php foreach ($games as $game): ?>
                                        <option value="<?php echo $game['game_id']; ?>" 
                                            <?php if ($game['game_id'] == $schedule['game_id']) echo 'selected'; ?>>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="time" name="time" 
                                       required value="<?php echo substr(htmlspecialchars($schedule['time']), 0, 5); ?>" 
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                    ...
                    <a href="delete.php?type=schedule&id=<?php echo $id; ?>" 
