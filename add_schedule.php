...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result === true) {
        setMessage('success', 'Schedule created.');
...
-body
    ...
    <div class="container">
        <h2>Add Schedule <i class="bi bi-calendar-plus"></i></h2>
        ...
        <form method="POST" onsubmit="return validateScheduleForm();">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="date" name="date" required min="<?php echo date('Y-m-d'); ?>" aria-label="Schedule date">
            </div>
            <div class="mb-3">
                <label for="time" class="form-label">Time (HH:MM) <i class="bi bi-clock"></i></label>
                <input type="time" class="form-control" id="time" name="time" required aria-label="Schedule time">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">Save Schedule <i class="bi bi-save"></i></button>
        </form>
    </div>
    <footer>
