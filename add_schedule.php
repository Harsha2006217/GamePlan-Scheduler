...
<body>
    ...
    <div class="container">
        <div class="section">
            <div class="text-center mb-5">
                ...
                <p class="text-muted">Plan your gaming sessions and coordinate with friends</p>
            </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <div class="form-text text-muted">
                                    Choose the game you want to schedule a session for
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="date" name="date" 
                                       required min="<?php echo date('Y-m-d'); ?>" aria-label="Schedule date">
                                <div class="form-text text-muted">
            ...
            <div class="mt-5 p-4 rounded" style="background: rgba(255,255,255,0.05);">
                <h5 class="mb-3"><i class="bi bi-lightbulb me-2"></i>Scheduling Tips</h5>
                <div class="row">
                    <div class="col-md-6">
                        <ul class="text-muted">
                            <li>Consider time zones when scheduling with friends</li>
                            <li>Plan sessions during peak gaming hours for better matchmaking</li>
                            <li>Allow buffer time for setup and warm-up</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="text-muted">
                            <li>Schedule regular sessions for consistent team practice</li>
                            <li>Consider your friends' availability patterns</li>
                            <li>Use descriptive session names for clarity</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script>
        function validateScheduleForm() {
            ...
            // Check if at least one friend is selected (if friends exist)
            const friendCheckboxes = document.querySelectorAll('input[name="friends[]"]');
            if (friendCheckboxes.length > 0) {
                const atLeastOneSelected = Array.from(friendCheckboxes).some(checkbox => checkbox.checked);
                if (!atLeastOneSelected) {
                    if (!confirm('No friends selected. Continue without inviting anyone?')) {
                        return false;
                    }
                }
            }
