...
if (!$event) {
    setMessage('error', 'Event not found or no permission to edit.');
    header('Location: index.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $shared_friends_arr = $_POST['shared_friends'] ?? [];
    $result = editEvent($id, $title, $date, $time, $description, $reminder, $schedule_id, $shared_friends_arr);
    if ($result === true) {
    ...
    <div class="container">
        <div class="section">
            <div class="text-center mb-5">
                ...
                <h1 class="h2 mb-3">Edit Gaming Event</h1>
                <p class="text-muted">Update your event details and settings</p>
            </div>
            ...
            <div class="event-info">
                <h5 class="mb-3"><i class="bi bi-info-circle me-2"></i>Current Event Details</h5>
                <div class="row">
                    <div class="col-md-4">
            ...
            <form method="POST" onsubmit="return validateEventForm();">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <div class="character-count" id="titleCount"><?php echo strlen($event['title']); ?>/100 characters</div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="time" name="time" 
                                       required value="<?php echo substr(htmlspecialchars($event['time']), 0, 5); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                                  ...
                                  aria-label="Event description"><?php echo htmlspecialchars($event['description']); ?></textarea>
                        <div class="character-count" id="descriptionCount"><?php echo strlen($event['description']); ?>/500 characters</div>
                        <div class="form-text text-muted">
                                    ...
                                    <select class="form-select" id="schedule_id" name="schedule_id" aria-label="Link schedule">
                                        ...
                                        <?php foreach ($schedules as $sched): ?>
                                            <option value="<?php echo $sched['schedule_id']; ?>" 
                                                <?php if ($sched['schedule_id'] == $event['schedule_id']) echo 'selected'; ?>>
                                    ...
                                    <div class="friend-item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   <?php if (in_array($friend['user_id'], $shared_friends)) echo 'checked'; ?>>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                    ...
                    <a href="delete.php?type=event&id=<?php echo $id; ?>" 
